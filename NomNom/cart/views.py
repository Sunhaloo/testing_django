...
def add_to_cart_ajax(request):
    ...
    try:
        ...
        try:
            ...
            print(f"Product not found: name={product_name}, category={product_category}")
...
def view_cart(request):
    ...
    for item in cart_items:
        ...
        cart_data.append({
            ...
            'pickup_date': str(item.pastry.pickup_date) if item.pastry.pickup_date else None,
        })
